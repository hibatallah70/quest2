    ...
    <form method="post">
        <table>
            ...
            <%
                ...
                com0.CommandText = "select idQuest,titreQuest,convert(varchar,dateouverture, 103) ,convert(varchar,datefermeture, 103) ,etatQuest,urlQuest from questionnaire";
            ...
            <tr>
                ...
                <td><a onclick=" return alert('Vous avez déjà rempli ce questionnaire');" </a></td>

                <%}
                    else
                    {  %>
                <td><a href="<%=dr0.GetString(5)%>">Remplir questionnaire</a></td>
